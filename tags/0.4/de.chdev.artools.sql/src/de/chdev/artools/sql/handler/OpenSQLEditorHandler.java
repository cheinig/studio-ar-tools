...
import de.chdev.artools.sql.editor.SQLEditorInput;
...
public class OpenSQLEditorHandler extends AbstractHandler{
	...
	IEditorInput input = new SQLEditorInput(ARHelpTools.getInstance().getCurrentStore());
	IWorkbenchWindow window = HandlerUtil.getActiveWorkbenchWindow(event);
	IWorkbenchPage page = window.getActivePage();
	try {
	    page.openEditor(input, "de.chdev.artools.sql.editor.sql");
